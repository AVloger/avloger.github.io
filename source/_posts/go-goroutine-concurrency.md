...
_图片来源：Wikimedia Commons，Go Logo Blue.svg。Go 标识本身是简单几何/文字标识；具体使用仍需遵守 Go 品牌规范。_
...
- [Go Logo Blue.svg](https://commons.wikimedia.org/wiki/File:Go_Logo_Blue.svg)：本文封面图来源。
