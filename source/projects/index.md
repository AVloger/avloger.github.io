...
<div class="projects-page">
  ...
  <section class="project-block">
    ...
    <div class="project-video">
      <div class="video-frame">
        <iframe src="https://player.bilibili.com/player.html?bvid=BV19P9TB3E3r&autoplay=0" scrolling="no" allowfullscreen="true"></iframe>
      </div>
    </div>
  </section>
  ...
  <section class="project-refs">
    <h2>参考链接</h2>
    <ul>
      <li><a href="https://leslieaibin.github.io/projects" target="_blank" rel="noopener">SLS SQL/SPL Copilot 演示来源</a></li>
